      ...
      <el-card class="box-card cardDiv1">
        ...
        <el-col :span="5">
          <div class="box-div card2">
            <div class="webBox">
              <div class="webO">今日发起审批数量:</div>
              <div class="webT">239</div>
            </div>
          </div>
        </el-col>
        <el-col :span="5">
...
<!--            <span style="margin-right: 30px">订单信息</span>-->
            <el-badge :value="19" class="item">
              <el-button type="text" size="small">待处理审批</el-button>
            </el-badge>
...
<!--            </el-table-column>-->
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <span v-if="scope.row.status==='1'" style="color: #FF9933">进行中</span>
                <span v-if="scope.row.status==='2'" style="color: #FF5722">已取消</span>
                <span v-if="scope.row.status==='3'" style="color: #1890ff">已完成</span>
              </template>
            </el-table-column>
            <el-table-column
              label="操作">
...
<!--            </el-table-column>-->
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <span v-if="scope.row.level==='1'"><el-tag type="danger">超级管理员</el-tag></span>
                <span v-if="scope.row.level==='2'"><el-tag type="success">管理员</el-tag></span>
                <span v-if="scope.row.level==='3'"><el-tag type="warning">主管用户</el-tag></span>
